...
Jami has a professional-looking design and is available for a wide range of platforms. Unlike other alternatives, calls using Jami are direct between users, as it does not use servers to handle calls.
